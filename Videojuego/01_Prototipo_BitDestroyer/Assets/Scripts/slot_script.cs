        ...
        if (Input.GetMouseButtonUp(0) && isDragging)
        {
            ...
            foreach (Transform slot in cardSlots)
            {
                if (IsWithinArea(selectedCard.transform, slot))
                {
                    ...
                    switch (defenseCard, attackCard, bootcampCard_25, bootcampCard_06, botcampCard_29, bootcampCard_22)
                    {
                        case (DefenseCard _, null, null, null, null, null):
                            // Si es una carta de defensa, no hacer nada
                            Debug.Log("Defense Card - No Action Taken");
                            break;
                        case (null, AttackCard ac, null, null, null, null):
                            // Si es una carta de ataque, activar el disparo
                            ac.startShooting = true;
                            Debug.Log("Attack Card onOff set to true");
                            break;
                        case (null, null, BootcampCard_25 bc, null, null, null):
                            ...
                            break;
                        case (null, null, null, BootcampCard_06 bc, null, null):
                            ...
                            break;
                        case (null, null, null, null, BootcampCard_29 bc, null):
                            ...
                            break;
                        case (null, null, null, null, null, BootcampCard_22 bc):
